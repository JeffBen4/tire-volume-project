# I added a function to test the convertion of kpa to psi
from water_flow import water_column_height, pressure_gain_from_water_height, \
    pressure_loss_from_pipe, pressure_loss_from_fittings, pressure_loss_from_pipe_reduction, kpa_to_psi
...
def test_reynolds_number():
    ...
    assert reynolds_number(0.048692, 1.65) == approx(80069.0, abs=1)
    assert reynolds_number(0.048692, 1.75) == approx(84922.0, abs=1)
...
def test_kpa_to_psi():
    ...
    assert kpa_to_psi(500) == approx(72.5189, abs=0.1)
